...
def appScreenCheck(screenType):
    type_dict = {'report': 'images/report.png', 'freezeUnfreeze': 'images/freeze.png', 'routing': 'images/routing.png', 'element': 'images/itemElement.png', 'overhead': 'images/itemOverhead.png', 'prodStruct': 'images/prodStruct.png', 'dataMaint': 'images/itemMaint.png', 'supplierBrowse': 'images/supplierBrowse.png', 'supplierModify': 'images/supplierModify.png', 'supplierModify2': 'images/supplierModify2.png'}
